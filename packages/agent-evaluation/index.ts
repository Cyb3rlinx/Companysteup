...
export const WYOMING_AGENT_EVALUATION_VERSION='2026-09-14.5';
...
export type PatchAssessment={accept:boolean;correctFields:WyomingFieldId[];incorrectFields:WyomingFieldId[];missingFields:WyomingFieldId[];unexpectedFields:string[]};
