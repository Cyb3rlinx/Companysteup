...
export const GUIDE_VERSION = '2026-09-14.4';
...
export const COUNTRY_GUIDES: readonly CountryGuide[] = [
  ...
  },
  {
    ...
    sources: [source('ee-establishment', 'RIK: guía para constituir una OÜ', 'https://abiinfo.rik.ee/en/applications-and-dashboard/establishment-new-legal-person/establishment-private-limited-company'), source('ee-start', 'RIK: selección de forma jurídica', 'https://ariregister.rik.ee/eng/application/start', 'PUBLIC_PORTAL_ONLY'), source('ee-address', 'e-Residency: domicilio y persona de contacto', 'https://learn.e-resident.gov.ee/hc/en-gb/articles/360000624858-Contact-person-legal-address'), source('ee-ou', 'e-Residency: private limited company OÜ', 'https://learn.e-resident.gov.ee/hc/en-gb/articles/360000633557-Private-limited-company-O%C3%9C'), source('ee-api', 'RIK: Company Registration API', 'https://www.rik.ee/en/other-services/company-registration-api')],
    fields: [field('Actividad principal EMTAK, ejercicio, nombre y correo de contacto', 'e-Business Register: Activity, Name, Address and Contacts', 'ee-establishment'), field('Domicilio estonio o extranjero y necesidad de persona de contacto', 'Address and Persons; licencia, contrato y consentimiento se verifican aparte', 'ee-address'), field('Fundadores, directorio, representación y beneficiarios finales', 'Persons and Beneficial Owners; sin códigos personales en este laboratorio', 'ee-establishment', true), field('Capital, participaciones, derechos especiales y estatutos', 'Capital and Articles of Association; aporte y revisión separados', 'ee-establishment'), field('Identidad digital y firma de todas las personas correspondientes', 'Confirmation del portal oficial; PIN y credenciales bajo control exclusivo de cada firmante', 'ee-establishment', true), field('Tasa estatal, presentación y decisión registral', 'Pago y envío en el portal oficial; este producto no ejecuta esas acciones', 'ee-establishment', true)],
  },
  {
