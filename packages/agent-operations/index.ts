...
const evidence:readonly ConnectedEvidence[]=[
 {jurisdiction:'US-WY',label:'Wyoming LLC',connectedEvidenceVersion:'2026-09-14.4',currentEvaluationVersion:WYOMING_AGENT_EVALUATION_VERSION,evaluatedAt:'2026-09-14T06:56:26.265Z',requestCount:49,requestMaximum:60,totalTokens:27212,passedScenarios:4,totalScenarios:4,externalWrites:0,fieldCount:WY_FIELDS.length},
