# Validación del servicio por jurisdicción

Investigación: 2026-09-03, Asia/Bangkok. Estado: `PENDING_REVIEW`. Ninguna observación constituye aprobación profesional, vigencia de una regla ni autorización para tramitar.
...
## Matriz de entrega y límites

| Ruta | Lo que puede preparar el sistema | Dónde se detiene | Siguiente validación |
|---|---|---|---|
...
| Hong Kong | Mapa NNC1, estatutos, IRBR1 y participantes | Secretario elegible, domicilio, identidad, firmas y registro | Proveedor/licencia o exención aplicable, acceso permitido y conciliación |

Los pasos de autoridad nunca se sustituyen por una respuesta del asistente. La llegada a un portal público no demuestra acceso al formulario, elegibilidad, aceptación del expediente ni registro.

## Fuentes y observaciones

**Wyoming.** Se inspeccionaron las [instrucciones públicas del portal](https://wyobiz.wyo.gov/Business/RegistrationInstr.aspx) y el [formulario de Articles of Organization](https://sos.wyo.gov/Forms/Business/LLC/LLC-ArticlesOrganization.pdf). El aviso sobre nombres que comienzan con A importa para el fixture “Andes”: no se debe ofrecer un recorrido en línea uniforme. Se puede preparar el formulario; firmarlo, aceptar declaraciones y pagar corresponden a personas autorizadas.

**Delaware.** [How to form](https://corp.delaware.gov/howtoform/), [paquetes de nuevas entidades](https://corp.delaware.gov/newentit09/) y [Document Upload](https://corp.delaware.gov/document-upload-service-information/) distinguen preparación de documentos y procesamiento posterior. Como diferencia a evaluar, el [LLC Act, § 18-1101](https://delcode.delaware.gov/title6/c018/sc11/index.html) prioriza libertad contractual; esto no demuestra que una LLC sea preferible para cualquier inversión. Las discrepancias de tarifas ya registradas necesitan revisión, no una selección automática por IA.

**EE. UU., EIN.** Las [instrucciones SS-4 del IRS](https://www.irs.gov/instructions/iss4) distinguen los solicitantes cuyo domicilio/establecimiento principal está fuera de EE. UU. La nacionalidad no basta para elegir el canal. El número fiscal y la identidad del responsable se ingresan únicamente en un canal autorizado; no se piden en el laboratorio.
...
**Singapur.** [ACRA: elegibilidad](https://www.acra.gov.sg/register/business/requirements-eligibility/) y [registro mediante Bizfile](https://www.acra.gov.sg/register/business/registering-different-business-structures/local-company/registering-via-bizfile/) sustentan la entrega mediante CSP para extranjeros y la información de compañía/participantes. No se accedió a una sesión Singpass/Corppass ni se obtuvieron aprobaciones.

**Hong Kong.** Las FAQ de [incorporación](https://www.cr.gov.hk/en/faq/local-company/incorporation.htm), [directores/secretario](https://www.cr.gov.hk/en/faq/local-company/directors-secretary.htm) y [presentación electrónica](https://www.cr.gov.hk/en/electronic/e-servicesportal/faq/business-registration.htm) permiten mapear documentos y responsables. Director no residente no elimina los requisitos de secretario y domicilio local. No se creó cuenta oficial ni se presentaron formularios.

El catálogo `packages/formation-guidance/catalog.ts` conserva los destinos exactos y distingue contenido público inspeccionado, portal público solamente y enlace trasladado. No son snapshots regulatorios aprobados. El recheck interno del 17 de septiembre bloquea la preparación al vencer; no expresa la fecha efectiva ni la vigencia jurídica de una norma.
...
5. Operaciones: ampliar el admin existente con agente/versión, usuario/organización, etapa y responsable, dato pendiente, último evento, bloqueo, evidencia, revisión y SLA. La evaluación del laboratorio es una señal separada del estado jurídico.
6. Piloto: un expediente autorizado con proveedor y revisión. Evidencia real de la autoridad antes de afirmar constitución. Stripe permanece diferido hasta aprobar este hito.

No se necesitan más credenciales de GitHub ni repetir el login de Supabase para continuar la preparación. La ejecución externa y la publicación regulatoria permanecen `EXTERNAL_BLOCKED`.
